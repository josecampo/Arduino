/*
  Ing. Tecnología y Servicios de Telecomunicación
  Alumno: José Campo González
  Proyecto para el sector de la automoción
  Descripción del proyecto: Sensor de aviso al conductor cuando aparca para no golpear el vehículo durante la maniobra.
*/
// Pines utilizados
#define LEDVERDE 2
...
// Constantes
const float sonido = 34300; // Velocidad del sonido en cm/s
const float umbral1 = 20.0;
const float umbral2 = 10.0;
...
// Método que inicia la secuencia del Trigger para comenzar a medir la distancia
void iniciarTrigger()
{
  // Ponemos el pin Trigger en estado bajo y esperamos 2ms
